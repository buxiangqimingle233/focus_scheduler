...
class Individual():
    ...
    def addImNode(self):
        ...
        im_nodes = deepcopy(sel_pkt["intermediate"])
        additional = random.choice(range(self.array_size))
        im_nodes.append(additional)
        im_nodes = list(set(im_nodes))
        sel_pkt["intermediate"] = im_nodes
