...
python3 focus.py -bm benchmark/gpt2-xl.yaml -graph --graph_name ./op_graph_output/gpt2-xl.gpickle -d 128 -b 8 -fr 1024-1024-1024 ds

python3 compiler/graph_analyzer2.py -debug --op_file ./op_graph_output/gpt2-xl.gpickle --diameter 128 --reticle_size 16 --reticle_cycle 5 
