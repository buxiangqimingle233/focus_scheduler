...
python focus.py -bm benchmark/multi-model-2.yaml -d 16 s &
python focus.py -bm benchmark/multi-model-3.yaml -d 16 s &
python focus.py -bm benchmark/pipeline.yaml -d 16 s &
wait
...
# test
# python focus.py -bm benchmark/test.yaml -d 16 d