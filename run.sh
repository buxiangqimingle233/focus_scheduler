...
python3 compiler/graph_analyzer2.py -debug --op_file ./op_graph_output/mobilenet_v3_large_8.gpickle --diameter 32 --reticle_size 16 --reticle_cycle 5 >output.temp
